...
typedef void (*opera_cdrom_audio_play_cb_t)(const uint32_t start_lba_,
                                            const uint32_t end_lba_);
typedef void (*opera_cdrom_audio_stop_cb_t)(void);
...
struct cdrom_callbacks_s
{
  ...
  opera_cdrom_audio_play_cb_t  audio_play;
  opera_cdrom_audio_stop_cb_t  audio_stop;
};
