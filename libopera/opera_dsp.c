                  ...
                  bool            *work_)
{
  ...
  return dsp_fast_interpret_block(base,base + DSP_PULSE_14_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
                     ...
                     bool            *work_)
{
  ...
  return dsp_fast_interpret_block(pc,pc + DSP_SPLITEXEC_7_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
                       ...
                       bool            *work_)
{
  ...
  return dsp_fast_interpret_block(pc,pc + DSP_TIMESPLUS_7_2_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
                      ...
                      bool            *work_)
{
  ...
  return dsp_fast_interpret_block(pc,pc + DSP_DELAY1TAP_16_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
                     ...
                     bool            *work_)
{
  ...
  return dsp_fast_interpret_block(pc,pc + DSP_DELAYMONO_8_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
                        ...
                        bool            *work_)
{
  ...
  return dsp_fast_interpret_block(pc,pc + DSP_DELAYSTEREO_10_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
                             ...
                             bool            *work_)
{
  ...
  return dsp_fast_interpret_block(pc,pc + DSP_DIRECTOUT_8_3HK_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
