...
#define DSP_ADPCMHALFMONO_71_374_WORDS 69
...
{
  static uint32_t const vals[DSP_ADPCMHALFMONO_71_374_WORDS] = {
  ...
  static uint32_t const masks[DSP_ADPCMHALFMONO_71_374_WORDS] = {
  ...
  return dsp_fast_pattern_match(pc_,DSP_ADPCMHALFMONO_71_374_WORDS,vals,masks);
}
                              ...
                              bool            *work_)
{
  ...
  return dsp_fast_interpret_block(base,base + DSP_ADPCMHALFMONO_71_374_WORDS,
                                  Y_,flags_,fExact_,RBSR_,work_);
}
