...
vdlp_render_line_0RGB1555_hires(void)
{
  ...
  dst0  = g_CURBUF;
  dst1 += (width << 1);
  src0 = (uint16_t*)(g_VRAM + ((g_VDLP.curr_bmp^2) & 0x0FFFFF) + (0 * 1024*1024));
  src1 = (uint16_t*)(g_VRAM + ((g_VDLP.curr_bmp^2) & 0x0FFFFF) + (1 * 1024*1024));
  src2 = (uint16_t*)(g_VRAM + ((g_VDLP.curr_bmp^2) & 0x0FFFFF) + (2 * 1024*1024));
  src3 = (uint16_t*)(g_VRAM + ((g_VDLP.curr_bmp^2) & 0x0FFFFF) + (3 * 1024*1024));

  for(x = 0; x < width; x++)
    {
      *dst0++ = vdlp_render_pixel_0RGB1555(*src0,bypass_clut);
      *dst0++ = vdlp_render_pixel_0RGB1555(*src1,bypass_clut);
      *dst1++ = vdlp_render_pixel_0RGB1555(*src2,bypass_clut);
      *dst1++ = vdlp_render_pixel_0RGB1555(*src3,bypass_clut);
...
vdlp_render_line_RGB565_hires(void)
{
  ...
  for(x = 0; x < width; x++)
    {
      *dst0++ = vdlp_render_pixel_RGB565(*src0,bypass_clut);
      *dst0++ = vdlp_render_pixel_RGB565(*src1,bypass_clut);
      *dst1++ = vdlp_render_pixel_RGB565(*src2,bypass_clut);
      *dst1++ = vdlp_render_pixel_RGB565(*src3,bypass_clut);
...
vdlp_render_line_XRGB8888(void)
{
  ...
  for(x = 0; x < width; x++)
    {
      *dst = vdlp_render_pixel_XRGB8888(*src,bypass_clut);
...
vdlp_render_line_XRGB8888_hires(void)
{
  ...
  for(x = 0; x < width; x++)
    {
      *dst0++ = vdlp_render_pixel_XRGB8888(*src0,bypass_clut);
      *dst0++ = vdlp_render_pixel_XRGB8888(*src1,bypass_clut);
      *dst1++ = vdlp_render_pixel_XRGB8888(*src2,bypass_clut);
      *dst1++ = vdlp_render_pixel_XRGB8888(*src3,bypass_clut);
